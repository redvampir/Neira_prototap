...
## Миграция (ключевые вопросы)

- **Источник данных:** какие существующие артефакты переносим в первую очередь (pathways, память, шаблоны ответов).
- **Порядок этапов:** сначала ядро и офлайн‑контур, затем инструменты интеграции и внешние провайдеры.
- **Критерий «готово»:** автономность ≥ 70% без LLM и стабильный деградированный режим при отсутствии сети.
- **Риски:** потеря полезных паттернов при переносе, расхождение статистики автономности, рост p95‑латентности.
